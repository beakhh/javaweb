...
public class MemberUpdateCommand implements MemberInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(tel[1].equals(" ")) tel[1] = ""; // 공백 중요
		if(tel[2].equals(" ")) tel[2] = ""; // 공백 중요
		...
		if(address[0].equals(" ")) address[0] = ""; // 공백 중요
		if(address[1].equals(" ")) address[1] = ""; // 공백 중요
		if(address[2].equals(" ")) address[2] = ""; // 공백 중요
		if(address[3].equals(" ")) address[3] = ""; // 공백 중요
