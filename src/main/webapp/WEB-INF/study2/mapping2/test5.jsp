...
<div class="container">
  ...
  <hr/>
  <div>
  	<form name="myform" method="post" action="${ctp}/Test5_5.mi">  <!-- Test의 T가 대문자인 이유는 컨트롤에서 받는 게 대문자로 되어있기 때문 -->
  		<div>
  ...
  <div>
  	...
  	<input type="button" value="구구단출력(5_3출력)" onclick="gugudan()" class="btn btn-secondary"/>
  </div>
</div>
<p><br/></p>
