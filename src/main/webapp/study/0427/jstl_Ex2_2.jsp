  ...
  <script>
    ...
    function pictureCheck() {
    	...
    	if(picture == "") {
    		...
    		pictureArray.push(picture); 					 // 배열에 저장
    		pictureNameArray.push(pictureName);    // 배열에 저장
...
<div class="container">
  ...
  <form name="myform" method="post" action="${pageContext.request.contextPath}/t0427/Jstl_Ex2_2Ok">
    <div class="row">
	  ...
	  <hr/>
	  <div id="demo"></div>
		<input type="hidden" name="pictureArray"/> <!-- hidden을 사용하는 이유는 폼태그에서 submit으로 값을 옯기기 위해서 사용했다. 43줄 -->
